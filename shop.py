...
items = [
        ...
        {"name" : "attack boost", "price" : 6, "count" : 0, "available" : 2, "description": "Increase your attack power +1", "icon" : "icon/items_free_l/64x64/sword_blue.png", "frequency" : 5},
        ...
        {"name" : "critical damage", "price" : 7, "count" : 0, "available" : 1, "description": "Increase the chance to inflict critical damage", "icon" : "icon/items_free_l/64x64/sword_power.png", "frequency" : 3},
        ...
        {"name" : "great attack boost", "price" : 12, "count" : 0, "available" : 1, "description": "Increase your attack power +3", "icon" : "icon/items_free_l/64x64/sword_blue.png", "frequency" : 1.5},
]
